            ...
            >
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="Active">Aktivní požadavek</option>
                  <option value="Suspended">Neaktivní požadavek</option>
                </Control.select>
              </div>
              <div className="form-group">
                <label htmlFor=".default" className="form-label">
                  Automatický požadavek při aktivaci firmy:
                </label>
                <Control.select
                  model=".default"
                  required
              ...
              <div className="form-group">
                <label htmlFor=".defaultForSpecificNACE" className="form-label">
                  Požadavek automaticky spouštěná při aktivaci firmy se
                  specifickým NACE:
                </label>
                <Control.text
              ...
              {!isPosting &&
                <div className="form-group">
                  <button
                    ...
                    className="btn btn-default btn-lg btn-block"
                  >
                    {this.props.match.path === "/admin/sablony/vytvorit" &&
                      <span>Vytvořit </span>}
                    {this.props.match.path != "/admin/sablony/vytvorit" &&
                      <span>Upravit </span>}
                    požadavek
